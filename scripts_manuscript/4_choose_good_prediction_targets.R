...
##
## Corresponds to results in Figure 5. and Supplementary Table 5.
##############################################################################
...
ggplot(corr522_alpha_series, aes(max_corr)) +
  ...
  labs(x="Correlation")
# ggsave("figures/histogram_predict_ausdb_corr522_paper.pdf", width=5, height=3.25, units="in")

ggsave("figures/adj_histogram_predict_ausdb_corr522_5.pdf", width=9, height=6, scale=1, units="cm")
ggsave("figures/adj_histogram_predict_ausdb_corr522_5.tiff", width=6, height=6, scale=1, units="cm")
ggsave("figures/adj_histogram_predict_ausdb_corr522_5.svg", width=6, height=6, scale=1, units="cm")
